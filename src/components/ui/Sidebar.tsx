...
import { useIsMobile } from "@trustify/components/hooks/use-mobile";
...
import { Sheet, SheetContent, SheetTitle } from "@trustify/components/ui/Sheet";
  ...
  if (isMobile) {
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetTitle className="hidden">Sidebar Title</SheetTitle>
        <SheetContent
